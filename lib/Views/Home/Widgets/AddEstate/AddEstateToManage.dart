...
class AddEstateToManage extends StatefulWidget {
  const AddEstateToManage({super.key});

  @override
  State<AddEstateToManage> createState() => _AddEstateToManageState();
}

enum SingingCharacter { lafayette, jefferson }
enum PaymentsSystem { monthly, annually, Semi_annually, Quarterly }

class _AddEstateToManageState extends State<AddEstateToManage> {
