                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: () async{
                              ...
                              var sig = ref.watch(signatureProvider);
                              print("fdsgdfg${sig.data}");
                    ...
                    onPressed: ()async {
                      if(signature.data != null) {
                        if (_formKey.currentState!.validate()) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("من فضلك قم بادخال البيانات الفارغة",style: TextStyle(color: Colors.black),)));
