//
// import 'package:aqary/Views/base/rating_bar.dart';
...
//                           )) : Consumer(builder: (context, cart, child) => Row(children: [
//                             InkWell(
//                               onTap: () {
//
//                               },
...
//                               if (isExistInCart) {
//                                 showCustomSnackBar('already_added');
//                               } else if (stock! < 1) {
//                                 showCustomSnackBar('out_of_stock');
//                               } else {
//                                // Provider.of<CartProvider>(context, listen: false).addToCart(cartModel!);
//                                 showCustomSnackBar('added_to_cart', isError: false);
//                               }
//                             }else {
...
//                           ),
//                         ) :
//                         Consumer(builder: (context, cart, child) =>
//                             Row(
//                               mainAxisSize: MainAxisSize.min,
//                               children: [
//                                 InkWell(
