...
import '../model/response/base/api_response.dart';//import 'package:google_maps_flutter/google_maps_flutter.dart';
...
class LocationRepo {
  ...
  Future<ApiResponse> getArea(int city_id) async {
    try {
      final response = await dioClient!.get("${AppConstants.area}/$city_id",);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getDeliveryPrice(int area_id) async {
    try {
      final response = await dioClient!.get("${AppConstants.deliveryPrice}$area_id",);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
