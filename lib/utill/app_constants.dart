...
class AppConstants {
  static const String appName = 'Al Abraaj';
  static const double appVersion = 7.1;
  static const AppMode appMode = AppMode.release;
  static const String baseUrl = 'http://dashboard.alabraajkw.com';
 // static const String baseUrl = 'https://beta.yamalalsham.shop';
 ...
 // static const String searchLocationUri = '/api/v1/mapapi/place-api-autocomplete';
  ...
  //address
  static const String cities = '/api/v1/shipping/cities';
  static const String area = '/api/v1/shipping/areas';
  static const String deliveryPrice = '/api/v1/shipping/price/';
